...
public class EnemyMoveTowardsPlayerBlock : EnemyCodeBlock
{
    ...
    public override void ReadyCode(Enemy enemy)
    {
        Vector2 playerDelta = new Vector2(Player.Instance.Move.XPos - enemy.Move.XPos, Player.Instance.Move.YPos - enemy.Move.YPos);
    ...
    public override Enemy RunCode(Enemy paramEnemy)
    {
        ...
        enemy.Move.Move(parameters[0], parameters[1]);
